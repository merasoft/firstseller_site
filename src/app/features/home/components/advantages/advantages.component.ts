...
export class AdvantagesComponent {
  ...
  getIconPath(iconName: string): string {
    const icons: { [key: string]: string } = {
      ...
      'shopping-cart': 'M7 18c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12L8.1 13h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1zm16 16c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z',
      ...
      'refresh-cw': 'M4 12a8 8 0 0 1 8-8V2.5L16 6l-4 3.5V8a6 6 0 0 0-6 6c0 1 .23 1.94.64 2.78l-1.46 1.46A7.93 7.93 0 0 1 4 12zm16 0a8 8 0 0 1-8 8v1.5L8 18l4-3.5V16a6 6 0 0 0 6-6c0-1-.23-1.94-.64-2.78l1.46-1.46A7.93 7.93 0 0 1 20 12z',
      'smile': 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c.93 0 1.69.76 1.69 1.69S12.93 8.38 12 8.38s-1.69-.76-1.69-1.69S11.07 5 12 5zm0 13c-2.3 0-4.31-.99-5.73-2.56a1 1 0 1 1 1.46-1.37c1.11 1.22 2.7 1.93 4.27 1.93s3.16-.71 4.27-1.93a1 1 0 1 1 1.46 1.37C16.31 17.01 14.3 18 12 18z'
    };
